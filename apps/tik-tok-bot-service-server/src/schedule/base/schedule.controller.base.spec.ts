  ...
  test("POST /schedules", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        postDateTime: CREATE_RESULT.postDateTime.toISOString(),
      ...
      .expect([
        {
          ...
          postDateTime: FIND_MANY_RESULT[0].postDateTime.toISOString(),
  ...
  test("GET /schedules/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        postDateTime: FIND_ONE_RESULT.postDateTime.toISOString(),
